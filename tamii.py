")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="EmdHYYFw2mM0lV8xwmM9.g5/ZhXZvlpfZUHV1NALMoq.N1CnHh1qpIXa2m2ioo+N2/Z2Tm1AuydrJmJdxg7yhcA=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="EmzsV9i8fz0vDyTGQwgd.X5b/D8tzVh2vwfzAq/ACJq.8nrd2XPNIvI5VW6/NhWdIy5yVPLS3c/gW+0i9yLQ8Ro=")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="Em0UcQMHKxcjEawRJv6b.e0QSMeA+Nx4qroUUFIqdgW.raRCIPG3aFyqVlscNa5/gqx4/dvuqYAaK8cr4srCQSk=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="EmAYEUJicAiax5wNhZua.r5rHUZbmm8kdzZrXsPDx/G.vHJ4VmsiyLs0DuorkNpLQV/u3sKm6iM0iEdD3FCP0S0=")
kt.loginResult()
...
admin=["u7fc70a41f5a612e15b712369d1a4688c"]
wait = {
    'contact':False,
    'autoJoin':False,
...
#==========================================
            if msg.text in ["kopi kak","kopi bos"]:
                if msg.from_ in admin:
                     wait["copy"] = True
                     cl.sendText(msg.to,"biar gak stress")
                else:
                     cl.sendText(msg.to,"You are not a admins")
            elif msg.text in ["kopi abis","kopi off"]:
                if msg.from_ in admin:
                    wait["copy"] = False
                    cl.sendText(msg.to,"besok lagi")
                else:
                    cl.sendText(msg.to,"You are not a admins")

            elif msg.from_ in wait["target"] and wait["copy"] == True and wait["copy2"] == "target":
                for i in range(1):
                    cl.sendText(msg.to,msg.text)
                    wait["copy"] = False
                wait["copy"] = True
            elif "Ikut " in msg.text:
                if msg.from_ in admin:
                    if wait["copy"] == True:
                        siapa = msg.text.replace("Ikut ","")
                        if siapa.rstrip('  ') == "me":
                            wait["copy2"] = "meee"
                            cl.sendText(msg.to,"plagiatku")
                        elif siapa.rstrip('  ') == "dia":
                            wait["copy2"] = "dia"
                            cl.sendText(msg.to,"...")
                        else:
                            cl.sendText(msg.to,"gak kenal")
                    else:
                        cl.sendText(msg.to,"buat dulu kopinya")
                else:
                    cl.sendText(msg.to,"You are not a admins")
            elif "Halo kak @" in msg.text:
                if msg.from_ in admin:
                    ...
                    if targets == []:
                        cl.sendText(msg.to, "oiii")
                    else:
                        for t in targets:
                            wait["target"][t] = True
                        cl.sendText(msg.to,"oii")
                else:
                    cl.sendText(msg.to,"siapa sih")
            elif "Udahan @" in msg.text:
                if msg.from_ in admin:
                    ...
                    if targets == []:
                        ...
                        for t in targets:
                            del wait["target"][t]
                        cl.sendText(msg.to,"capek")
                else:
                    cl.sendText(msg.to,"You are not a admins")
            elif msg.text in ["siapa aja","Targetlist"]:
                if msg.from_ in admin:
                        if wait["target"] == {}:
                            cl.sendText(msg.to,"gak tau")
                        else:
                            mc = "Target copy user\n"
