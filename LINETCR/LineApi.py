...
class LINE:
  ...
  def sendVoiceWithURL(self, to_, url):
        """Send a Audio with given image url
        
        :param url: Audio url to send
        """
        path = 'tmp/pythonLines.data'
  ...
  def sendVideoWithURL(self, to_, url):
        """Send a Video with given image url
        
        :param url: Video url to send
        """
        path = 'tmp/pythonLiness.data'
