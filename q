...
import time,random,sys,json,codecs,threading,glob,datetime,subprocess,urllib3,os,requests,urllib
...
ki = LINETCR.LINE()
ki.login(token="Em5u4y7U7KfzbFMEV7Z7.rafGK7cOr9hRJb9QvCg59W.kF7OG6xzhdWhkF5i+z9vZEeKiRKk/I0SLaSuzGbrX/s=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Em1uUeNp7PYfzrigf8m4.v50BBEIkbFobwJRO4xF1ja.9S6xHMvFJyHG0EojwKXr1m5SMXcJTsReVYEoe5gQd08=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Emx5yfmrPp87hx3v4Ota.w3yS6Uk4LUlTSfJCoJllUG.5XnGAS9eQ2CQZlUnhSKzBRrzzi2lBGE/yQqzV9wGS3Q=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="EmiPtdumt3nNXeIO28g6.+yX/WQa5fXmWO1ff2UpoTG.ouVog3HhtEZaG9qB2Ht2EEvR+ETkdEzGYOvjRtExdyU=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Em7r67DKwoo08XQE35g0.EA0kjhVU/WrC92oiLAFzCa.dQUIBMbIuNFlOIH8nTb4ik5CqiR3/XIlk8S3x1T8lhA=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="Emij92Opju0A8fcbqlm4.q2JgEASRDYVoVJlY4Mo2Pa.90hf5L1m6SIPiVMbauaLeYTNZNNzxDr7h0bzeAphwW0=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="EmfnNZOrukZu4Ot5ruPe.i9tOgO19rMIvpVkZXS8d3G.80pCTjEOxtMhCi7Rzj+fOvm9TwSqb8VXgYEI1YyEHo0=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="Em5GXmOBnYaXRnMPZwX6.0BpK2oZ8lcbH2IkMPRYmjG.Twu52EmfrMXchKaLFQQNdkbTLy9/2fVcCF4X2+Uw1lc=")
kh.loginResult()
...
kl = LINETCR.LINE()
kl.login(token="EmZIg1lDmOYH949Rleec.1eIE4tCE1Xqdg7QPWuMPVa.HmOVfbbTn7nX4EW7pZQvDZpLTcjGuV45f/4BkmhTPJo=")
kl.loginResult()
...
ko = LINETCR.LINE()
ko.login(token="EmoQHRSpSbfnD7vacBr4.dT3xRe4uCjM6Vzg7k5eETa.DEUe9kBAv+SdKGb1yi42OpyVGd4iIMYVr830bRnRxqc=")
ko.loginResult()

kp = LINETCR.LINE()
kp.login(token="EmY8h36sYp8BzU6Icfh6.JdC4ALO58MA6pnJuI1CFzG.j7akOD4/Tmc20VlSpIwGmK2y7kUhbG9DEdKkdgLnGw4=")
kp.loginResult()
...
kr = LINETCR.LINE()
kr.login(token="Em1pldxYFW1KLLG1NfH1.7xu87tgEhnTXf8s1fWeH4q.hU6PsL1On8Dh+gT6pUmf/5X6c2lnaNiFiRA0VuxsWnE=")
kr.loginResult()
...
kt = LINETCR.LINE()
kt.login(token="EmRMSp9YRsRZEgnvrdW8.XjzOOkSRnvOPOjv8Ex6E6a.YnZQ3FtR6E62qfVLEZUF34hxraDKTWDFNunXymA+Tmo=")
kt.loginResult()
print "login success"
reload(sys)
...
#            cl.sendMessage(cb)
#            cb.text = cl.getContact(op.param2).displayName + "\n🇹🇭 รายชื่อกลุ่มโปรเเกรมทำงาน 🇹🇭\n" + group.name
#            cl.sendMessage(cb)
#
#        if op.type == 15:
#            if op.param2 in Bots:
#                return
#            cl.sendText(op.param1, "👋 เเล้วพบกันใหม่ 👋\n🙋 บายจร้าโชคดีนะครับ 🙋\n\n[ ᴀᴅᴍɪɴ ʙᴏᴛ ]\n[ By.เพชร ทีมทดลองบอท]")
#            print "MemberLeft"
#
...
#                else:md+=" �� Mimic : off\n"
                if wait["winvite"] == True: md+=" 􀜁􏿿 Invite : on 􏿿\n"
...
#========================================
            elif msg.text in ["Gu Tar","!phet","มาหำ"]:
					G = cl.getGroup(msg.to)
...
#==========================================
            ...
            elif msg.text.lower() == 'botcontactme':
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                ki.sendMessage(msg)
                kk.sendMessage(msg)
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = "u44016093b0a847d1eb8c1f6a55c1b9f7","u579d1b6de88a05f3815a3ae8e177f524","u5b762ceae2b896e2edb058dc3a32cbba","ufd8c7ec2a039171330a35145dae3ceb6","u79ad0a247beefb045cf7638895a7d970","u4368c679ab2b772bcebe32f2e263b6a4"
			if op.param2 in OWN:
				pass
			else:
				Inviter = op.param3.replace("",',')
